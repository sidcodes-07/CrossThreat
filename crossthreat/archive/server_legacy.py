...
This file is intentionally inert and must not be imported by the active app.
The active API entry point is C:\CyberShield\crossthreat\engines\server.py.
"""

raise RuntimeError("Legacy CrossThreat server is archived and disabled. Use engines/server.py as the only active backend entry point.")
